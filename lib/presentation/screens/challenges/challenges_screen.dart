                  ...
                  children: [
                    ...
                    Expanded(
                      child: Obx(() => Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(AppStrings.challengesTitle,
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('250 ${AppStrings.ptsToNextLevel}',
                              style: TextStyle(
          ...
          Expanded(
            child: Obx(() => ListView(
                  ...
                  children: [
                                      ...
                                      children: [
                                        ...
                                        Row(children: [
                                          ...
                                          Container(
                                            ...
                                            child: Text('${c.daysLeft} days left',
                                                style: TextStyle(
                                                    fontSize: 10.sp,
                                                    color:
                                ...
                                children: [
                                  Text('Progress',
                                      style: TextStyle(
                                          color: Colors.grey[500],
                                          fontSize: 12.sp)),
                                  Text('${c.daysCompleted}/${c.totalDays} days',
                                      style: TextStyle(
                                ...
                                children: [
                                  ...
                                  ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(
                                        ...
                                        padding: EdgeInsets.symmetric(
                                            horizontal: 16.w)),
                                    child: Text(AppStrings.logToday,
                                        style:
                    ...
                    Text(AppStrings.availableChallenges,
                        ...
                        child: AppCard(
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                padding:
                                    EdgeInsets.all(AppSizes.cardPadXl),
                                child: Column(
                                  children: [
                                    Row(
                                      children: [
