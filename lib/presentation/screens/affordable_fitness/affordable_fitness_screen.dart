...
class AffordableFitnessScreen extends StatelessWidget {
  ...
  static const _benefits = [
    [Icons.bolt_rounded, 'AI-Powered Plans', 'Personalized workout routines tailored to your fitness level'],
    [Icons.home_rounded, 'Home Workouts', 'Train anywhere, anytime with zero equipment'],
    [Icons.people_rounded, 'Community Support', 'Join thousands achieving their goals at home'],
    [Icons.star_rounded, '100% Free', 'No hidden costs, no subscriptions required'],
  ];
                ...
                Row(
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(AppStrings.affordableTitle,
                            style: AppTextStyles.h3.copyWith(color: Colors.white)),
                        Text(AppStrings.affordableSub,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text(AppStrings.everyoneDeserves,
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.w700,
                                    fontSize: 15)),
                            const SizedBox(height: 4),
                            Text(AppStrings.affordableDesc,
                                style: TextStyle(
              ...
              children: [
                ...
                AppCard(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Household Items as Equipment', style: AppTextStyles.h4),
                      const SizedBox(height: 4),
                      Text("Get creative! Here's how to use everyday items:",
...
class _FreeBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Text(AppStrings.freeLabel,
            style: TextStyle(
